...
(() => {
  ...
  const initNavActiveLinkByCurrentPath = () => {
  ...
  const initRoleFocusTypingRotator = () => {
  ...
  const initHudLocalTimeAsiaKolkata = () => {
  ...
  const initFilterBarProjectsExperience = () => {
  ...
  const initCopyEmailToClipboard = () => {
  ...
  const initCurrentYearStampForExperienceSince = () => {
  ...
  const initSlidingPhotoGalleriesSpeakingWorkshopPages = () => {
    const reduceMotion = window.matchMedia(
      "(prefers-reduced-motion: reduce)",
    ).matches;
  ...
  initNavScrollState();
  initNavMobileToggle();
  initNavActiveLinkByCurrentPath();
  initScrollReveal();
  initBackToTop();
  initRoleFocusTypingRotator();
  initAnimatedCounters();
  initHudLocalTimeAsiaKolkata();
  initFilterBarProjectsExperience();
  initCopyEmailToClipboard();
  initCurrentYearStampForExperienceSince();
  initSlidingPhotoGalleriesSpeakingWorkshopPages();
})();
